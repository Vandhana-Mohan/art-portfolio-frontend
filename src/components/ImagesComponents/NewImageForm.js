      ...
      <form onSubmit={handleSubmit} className="space-y-4 ">
        ...
        <div className="flex justify-center space-x-4">
          <button
            ...
            className="mt-4 bg-gray-300 text-xl tracking-wider font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mt-6 px-8 py-4 font-bold text-black text-2xl sm:text-lg md:text-xl font-semibold rounded-lg hover:from-pink-500 hover:to-yellow-500 hover:text-white shadow-yellow-500/50 shadow-md rounded focus:outline-none focus:shadow-outline"
          >
            Save
          </button>
          <button
