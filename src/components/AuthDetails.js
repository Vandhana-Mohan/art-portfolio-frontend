      ...
      {authUser ? (
        ...
        <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-4">
          <div>
            <Link
              to="/SignIn"
              className="mt-2 bg-gray-300 px-8 py-2 text-black text-xl sm:text-lg md:text-xl font-semibold rounded-lg hover:from-pink-500 hover:to-yellow-500 hover:text-white shadow-yellow-500/50 shadow-md font-bold flex items-center space-x-2"
            >
              Sign In
            </Link>
          </div>
